                ...
                inputSchema: [
                    ...
                    'properties' => [
                        ...
                        ...(Capabilities::installed('agent') ? [
                            ...
                            'expectation' => ['type' => 'string', 'description' => 'Immutable expected delivery before model or tool execution: JSON test {path, filter}, screen {name, type, definition?}, optional members [exact relative artifact paths]. Omit to retain it. Scope, not approval.'],
                            'deliveryCandidate' => ['type' => 'string', 'description' => 'Bind this native promoted candidate workspace to the previously declared expectation. The SDK derives its artifact and any declared member producers, preserving the expected test and screen.'],
