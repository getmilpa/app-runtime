...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa AppRuntime',
    nsPrefix: 'Milpa\\AppRuntime\\',
    installCommand: 'composer require milpa/app-runtime',
    repoUrl: 'https://github.com/getmilpa/app-runtime',
    pagesUrl: 'https://getmilpa.github.io/app-runtime/',
    heroParagraph: 'The agent runtime a Milpa app INSTALLS instead of copying: session gate, sub-agent delegation, tree budget, sterile-loop guard and the live bridge. Lives here so an existing app receives its improvements — a template that copies what nobody edits is a package in disguise.',
    utmContent: 'app-runtime',
);
